...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "x1eegXOBkAvSkkmdxiPcx2lvB", consumerSecret: "d2JhYjJ021xEOafOyBHBN4AxWFaljbIt4OURzwSIqGP88crXGu")
    var loginSuccess: (() -> ())?
